      ...
      , Q = function(e) {
        ...
        s._addTouchEventListeners = function() {
            var e = this
              ...
              , i = function(t) {
                e._pointerEvent && J[t.pointerType.toUpperCase()] && (e.touchDeltaX = t.clientX - e.touchStartX),
                e._handleSwipe(),
    ...
    e.fn.datetimepicker = function(n, s) {
        ...
        return r = function(t) {
            ...
            D.setOptions = function(n) {
                ...
                E.find(".xdsoft_today_button").css("visibility", S.todayButton ? "visible" : "hidden"),
                E.find("." + S.prev).css("visibility", S.prevButton ? "visible" : "hidden"),
                E.find("." + S.next).css("visibility", S.nextButton ? "visible" : "hidden"),
                q(S),
            ...
            D.on("xchange.xdsoft", (function(r) {
                ...
                s = setTimeout((function() {
                    ...
                    m += "</tbody></table>",
                    A.html(m),
                    E.find(".xdsoft_label span").eq(0).text(S.i18n[o].months[C.currentTime.getMonth()]),
                    E.find(".xdsoft_label span").eq(1).text(C.currentTime.getFullYear() + S.yearOffset),
                    L = O = "";
                    var P = 0;
                    if (!1 !== S.minTime) {
...
function(e) {
    ...
    var t, i, n, o, s, r, a = "Close", l = "BeforeClose", d = "MarkupParse", c = "Open", u = "Change", f = "mfp", h = "." + f, p = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", v = function() {}, y = !!window.jQuery, b = e(window), _ = function(e, i) {
        t.ev.on(f + e + h, i)
    }, w = function(t, i, n, o) {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push((function() {
    ...
    function p(e, t, i, n, o) {
        var l, d, c, u, f, p, m, g, v, y, b, _, w, x = e.length - 1, k = 0, T = e[0].a;
        for (l = 0; l < x; l++)
            d = (f = e[k]).a,
            c = f.d,
            u = e[k + 1].d,
            g = o ? (b = s[l],
            w = ((_ = r[l]) + b) * t * .25 / (n ? .5 : a[l] || .5),
            c - ((p = c - (c - d) * (n ? .5 * t : 0 !== b ? w / b : 0)) + (((m = c + (u - c) * (n ? .5 * t : 0 !== _ ? w / _ : 0)) - p) * (3 * b / (b + _) + .5) / 4 || 0))) : c - ((p = c - (c - d) * t * .5) + (m = c + (u - c) * t * .5)) / 2,
            p += g,
            m += g,
            f.c = v = p,
            f.b = 0 !== l ? T : T = f.a + .6 * (f.c - f.a),
            f.da = c - d,
            f.ca = v - d,
            f.ba = T - d,
            i ? (y = h(d, T, v, c),
    ...
    function m(e, t, i, n) {
        ...
        if (n)
            for (a = (e = [n].concat(e)).length; -1 < --a; )
                "string" == typeof (u = e[a][t]) && "=" === u.charAt(1) && (e[a][t] = n[t] + Number(u.charAt(0) + u.substr(2)));
        if ((o = e.length - 2) < 0)
            return h[0] = new f(e[0][t],0,0,e[0][t]),
            h;
        for (a = 0; a < o; a++)
            l = e[a][t],
            d = e[a + 1][t],
            ...
            s[a] = (s[a] || 0) + (d - l) * (d - l),
            r[a] = (r[a] || 0) + (c - d) * (c - d));
        return h[a] = new f(e[a][t],0,0,e[a + 1][t]),
        h
    }
    function g(e, t, i, n, o, d) {
        var c, u, f, h, g, v, y, b, _ = {}, w = [], x = d || e[0];
        for (u in o = "string" == typeof o ? "," + o + "," : ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,",
        null == t && (t = 1),
        e[0])
            w.push(u);
        if (1 < e.length) {
        ...
        for (s.length = r.length = a.length = 0,
        c = w.length; -1 < --c; )
            u = w[c],
            l[u] = -1 !== o.indexOf("," + u + ","),
            _[u] = m(e, u, l[u], d);
    ...
    c = _gsScope._gsDefine.plugin({
        ...
        init: function(e, t, i) {
            ...
            var n, o, s, r, a, l = t.values || [], d = {}, c = l[0], u = t.autoRotate || i.vars.orientToBezier;
            for (n in this._autoRotate = u ? u instanceof Array ? u : [["x", "y", "rotation", !0 === u ? 0 : Number(u) || 0]] : null,
            c)
                this._props.push(n);
            ...
            if (this._beziers = "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type ? g(l, isNaN(t.curviness) ? 1 : t.curviness, !1, "thruBasic" === t.type, t.correlate, a) : function(e, t, i) {
                var n, o, s, r, a, l, d, c, u, h, p, m = {}, g = "cubic" === (t = t || "soft") ? 3 : 2, v = "soft" === t, y = [];
                if (v && i && (e = [i].concat(e)),
                null == e || e.length < 1 + g)
                ...
                for (l = y.length; -1 < --l; ) {
                    ...
                    c = e.length,
                    d = 0; d < c; d++)
                        n = null == i ? e[d][u] : "string" == typeof (p = e[d][u]) && "=" === p.charAt(1) ? i[u] + Number(p.charAt(0) + p.substr(2)) : Number(p),
                    ...
                    d = h = 0; d < c; d += g)
                        ...
                        s = a[d + 2],
                        r = 2 == g ? 0 : a[d + 3],
                        a[h++] = p = 3 == g ? new f(n,o,s,r) : new f(n,(2 * o + n) / 3,(2 * o + s) / 3,s);
                    a.length = h
                }
                return m
            }(l, t.type, d),
        ...
        set: function(e) {
            var t, i, n, s, r, a, l, d, c, u, f, h = this._segCount, p = this._func, m = this._target, g = e !== this._startRatio;
            if (this._timeRes) {
                if (c = this._lengths,
                u = this._curSeg,
                f = e * this._length,
            ...
            if (this._autoRotate) {
                ...
                for (n = T.length; -1 < --n; )
                    ...
                    w += (v.c + (v.d - v.c) * a - w) * a,
                    l = g ? Math.atan2(w - b, _ - y) * k + x : this._initialRotations[n],
                    this._mod[s] && (l = this._mod[s](l, m)),
                    p[s] ? m[s](l) : m[s] = l)
            }
        }
        ...
        if (e) {
            ...
            t._registerComplexSpecialProp("bezier", {
                parser: function(e, t, s, r, a, l) {
                    ...
                    l = new c;
                    var d, u, f, h = t.values, p = h.length - 1, m = [], g = {};
                    if (p < 0)
                        return a;
                    for (d = 0; d <= p; d++)
                        f = i(e, h[d], r, a, l, p !== d),
                    ...
                    !g.autoRotate || g.autoRotate instanceof Array || (d = !0 === g.autoRotate ? 0 : Number(g.autoRotate),
                    g.autoRotate = null != f.end.left ? [["left", "top", "rotation", d, !1]] : null != f.end.x && [["x", "y", "rotation", d, !1]]),
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], (function(e, t) {
        ...
        function b(e, t) {
            return "function" == typeof e && (e = e(E, P)),
        ...
        var T, S, C, O, D, j, P, E, A, M, z = /(?:\-|\.|\b)(\d|\.|e\-)+/g, I = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, L = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, W = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b),?/gi, F = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, R = /(?:\d|\-|\+|=|#|\.)*/g, B = /opacity *= *([^)]*)/i, H = /opacity:([^;]*)/i, $ = /alpha\(opacity *=.+?\)/i, q = /^(rgb|hsl)/, N = /([A-Z])/g, Y = /-([a-z])/gi, G = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, U = /(?:Left|Right|Width)/i, X = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, J = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, Q = /,(?=[^\)]*(?:\(|$))/gi, V = /[\s,\(]/i, K = Math.PI / 180, Z = 180 / Math.PI, ee = {}, te = {
            ...
            _specialProps: l
        }, re = (_gsScope.navigator || {}).userAgent || "", ae = (A = re.indexOf("Android"),
        M = u("a"),
        C = -1 !== re.indexOf("Safari") && -1 === re.indexOf("Chrome") && (-1 === A || 3 < parseFloat(re.substr(A + 8, 2))),
        ...
        se.CSSPropTween = function(e, t, n, o, r, a, l, d, c, u, f) {
          ...
          , Se = r.parseComplex = function(e, t, i, n, o, s, a, l, d, c) {
            ...
            for (-1 === n.indexOf(",") && -1 === i.indexOf(",") || (O = -1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl") ? (C = C.join(" ").replace(Q, ", ").split(" "),
            O.join(" ").replace(Q, ", ").split(" ")) : (C = C.join(" ").split(",").join(", ").split(" "),
        ...
        function Ee(e, t, i, n, o, s) {
            var a, l, d, c, u, f, h, p, m, g, v, y, b, _, w = e._gsTransform, x = Qe(e, !0);
            w && (b = w.xOrigin,
            _ = w.yOrigin),
        ...
        function Ae(e) {
            ...
            if (f) {
                ...
                -1 !== t.indexOf("DXImageTransform.Microsoft.Matrix(") ? u.filter = t.replace(J, y) : u.filter = y + " " + t,
        ...
        var Me, ze, Ie, Le, We, Fe = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), Re = p("transform"), Be = le + "transform", He = p("transformOrigin"), $e = null !== p("perspective"), qe = se.Transform = function() {
        ...
        We), Ue = function(e) {
        ...
        }, Je = [1, 0, 0, 1, 0, 0], Qe = function(e, t) {
            var i, n, o, s, r, a, l, d = e._gsTransform || new qe, c = e.style;
            ...
            var s, a, l, d, c, u, f = n && e._gsTransform || new qe, h = f.scaleX < 0, p = $e && (parseFloat(ue(e, He, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin) || 0, m = parseFloat(r.defaultTransformPerspective) || 0;
            if (f.svg = !(!e.getCTM || !Xe(e)),
            f.svg && (Ee(e, ue(e, He, i, !1, "50% 50%") + "", f, e.getAttribute("data-svg-origin")),
            Me = r.useSVGTransformAttr || Ge),
            (s = Qe(e)) !== Je) {
                if (16 === s.length) {
                    var g, v, y, b, _, w = s[0], x = s[1], k = s[2], T = s[3], S = s[4], C = s[5], O = s[6], D = s[7], j = s[8], P = s[9], E = s[10], A = s[12], M = s[13], z = s[14], I = s[11], L = Math.atan2(O, E);
                    f.zOrigin && (A = j * (z = -f.zOrigin) - s[12],
                    M = P * z - s[13],
                    ...
                    f.scaleZ = (1e5 * Math.sqrt(j * j + P * P + E * E) + .5 | 0) / 1e5,
                    w /= f.scaleX,
                    S /= f.scaleY,
                    x /= f.scaleX,
                    C /= f.scaleY,
        ...
        , Ke = se.set3DTransformRatio = se.setTransformRatio = function(e) {
            var t, i, n, o, s, r, a, l, d, c, u, f, h, p, m, g, v, y, b, _, w, x, k, T = this.data, S = this.t.style, C = T.rotation, D = T.rotationX, j = T.rotationY, P = T.scaleX, E = T.scaleY, A = T.scaleZ, M = T.x, z = T.y, I = T.z, L = T.svg, W = T.perspective, F = T.force3D, R = T.skewY, B = T.skewX;
            if (R && (B += R,
            C += R),
            !((1 !== e && 0 !== e || "auto" !== F || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && F || I || W || j || D || 1 !== A) || Me && L || !$e)
                C || B || L ? (C *= K,
                x = B * K,
                k = 1e5,
                i = Math.cos(C) * P,
                ...
                L && Me ? this.t.setAttribute("transform", "matrix(" + b) : S[Re] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + b) : S[Re] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + P + ",0,0," + E + "," + M + "," + z + ")";
            else {
                if (O && (P < (m = 1e-4) && -m < P && (P = A = 2e-5),
                E < m && -m < E && (E = A = 2e-5),
                ...
                C || B)
                    ...
                    if (!(j || D || 1 !== A || W || L))
                        return void (S[Re] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) translate3d(" : "translate3d(") + M + "px," + z + "px," + I + "px)" + (1 !== P || 1 !== E ? " scale(" + P + "," + E + ")" : ""));
                    i = r = 1,
                    n = s = 0
                }
                c = 1,
                ...
                D || j || 1 !== A ? (b += _ + (d < m && -m < d ? w : d) + _ + (f < m && -m < f ? w : f) + _ + (o < m && -m < o ? w : o),
        ...
        (d = qe.prototype).x = d.y = d.z = d.skewX = d.skewY = d.rotation = d.rotationX = d.rotationY = d.zOrigin = d.xPercent = d.yPercent = d.xOffset = d.yOffset = 0,
        ...
        De("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(e, t, i, n, s, a, l) {
                ...
                d && (l.scale = d(E, e));
                var c, u, f, h, p, m, g, v, y, b = e._gsTransform, x = e.style, k = Fe.length, T = l, S = {}, C = "transformOrigin", O = Ve(e, o, !0, T.parseTransform), D = T.transform && ("function" == typeof T.transform ? T.transform(E, P) : T.transform);
                ...
                D && "string" == typeof D && Re)
                    ...
                    Ee(e, ge(T.transformOrigin), D, T.svgOrigin, T.smoothOrigin, !0),
                    m = D.xOrigin,
                    g = D.yOrigin,
                ...
                return D = "function" == typeof T.transformOrigin ? T.transformOrigin(E, P) : T.transformOrigin,
            ...
            if ((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                ...
                if ("all" === this.e)
                    ...
                    for (n = (t = this.e.split(" ").join("").split(",")).length; -1 < --n; )
                        i = t[n],
                        l[i] && (l[i].parse === a ? o = !0 : i = "transformOrigin" === i ? He : l[i].p),
                        tt(r, i);
                o && (tt(r, Re),
        ...
        d.parse = function(e, t, i, s) {
            ...
            for (r in t) {
                ...
                a)
                    ...
                    u = ue(e, r, o) + "",
                    v = "string" == typeof f,
                    "color" === r || "fill" === r || "stroke" === r || -1 !== r.indexOf("Color") || v && q.test(f) ? (v || (f = (3 < (f = ye(f)).length ? "rgba(" : "rgb(") + f.join(",") + ")"),
...
function(e, t) {
    ...
    u.totalTime = function(e, t, i) {
        ...
        if (this._timeline) {
            ...
            this._gc && this._enabled(!0, !1),
            this._totalTime === e && 0 !== this._duration || (H.length && ee(),
            this.render(e, t, !1),
            H.length && ee())
        }
        return this
    ...
    var L = x("TweenLite", (function(t, i, n) {
        ...
        if (this._overwrite = d = null == d ? Q[L.defaultOverwrite] : "number" == typeof d ? d >> 0 : Q[d],
    ...
    var H = []
      ...
      , ee = Y.lazyRender = function() {
        ...
        for ($ = {},
        e = 0; e < i; e++)
            (t = H[e]) && !1 !== t._lazy && (t.render(t._lazy[0], t._lazy[1], !0),
            t._lazy = !1);
        H.length = 0
    }
    ;
    ...
    u._initProps = function(t, i, n, o, s) {
        ...
        this.vars.css || t.style && t !== e && t.nodeType && G.css && !1 !== this.vars.autoCSS && function(e, t) {
            var i, n = {};
            for (i in e)
                J[i] || i in t && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!G[i] || G[i] && G[i]._autoCSS) || (n[i] = e[i],
                delete e[i]);
            e.css = n
        }(this.vars, t),
        this.vars)
  ...
  , universalParallax = function() {
    this.init = function(e) {
        ...
        for (var t = document.getElementsByClassName(e.className), i = 0; t.length > i; i++) {
            ...
            t[i].parentNode.insertBefore(n, t[i]),
            n.appendChild(t[i]);
            var o = t[i].parentElement;
            o.className += "parallax__container",
            "relative" !== window.getComputedStyle(o.parentElement, null).getPropertyValue("position") && (o.parentElement.style.position = "relative");
            var s = t[i].dataset.parallaxImage;
            void 0 !== s && (t[i].style.backgroundImage = "url(" + s + ")",
            1 === t[i].classList.length && "parallax" === t[i].classList[0] && (t[i].style.backgroundRepeat = "no-repeat",
            t[i].style.backgroundPosition = "center",
            t[i].style.backgroundSize = "cover"))
        }
        document.addEventListener("readystatechange", (function(i) {
            var n, o;
            "complete" === i.target.readyState && (n = t,
            (o = e.speed) < 1 && (o = 1),
            calculateHeight(n, o),
...
!function(e, t) {
    ...
    function s(e) {
        var t = !(arguments.length <= 1 || void 0 === arguments[1]) && arguments[1]
          ...
          , o = void 0;
        return null != document.createEvent ? (o = document.createEvent("CustomEvent")).initCustomEvent(e, t, i, n) : null != document.createEventObject ? (o = document.createEventObject()).eventType = e : o.eventName = e,
        o
    }
    function r(e, t, i) {
    ...
    l.notSupported = !0,
    d), h = window.getComputedStyle || function(e) {
        var t = /(\-([a-z]){1})/g;
        return {
    ...
    , p = function() {
        ...
        return c(e, [{
            ...
            value: function() {
                ...
                n(document.readyState, ["interactive", "complete"]) ? this.start() : r(document, "DOMContentLoaded", this.start),
                this.finished = []
            }
        }, {
            key: "start",
            value: function() {
                ...
                if (this.disabled() || (r(this.config.scrollContainer || window, "scroll", this.scrollHandler),
            ...
            value: function() {
                this.stopped = !0,
                a(this.config.scrollContainer || window, "scroll", this.scrollHandler),
            ...
            value: function(e) {
                ...
                1 === e.nodeType)
                    for (var t = (e = e.parentNode || e).querySelectorAll("." + this.config.boxClass), i = 0; i < t.length; i++) {
                        var o = t[i];
                        n(o, this.all) || (this.boxes.push(o),
                        this.all.push(o),
            ...
            value: function(e) {
                ...
                this.config.resetAnimation && (r(e, "animationend", this.resetAnimation),
