!function(e) {
    ...
    e.fn.vsmobilemenu = function(t) {
        ...
        return this.each((function() {
            ...
            function s() {
                ...
                e(s).each((function() {
                    e(this).hasClass(i.subMenuToggleClass) && (e(this).removeClass(i.subMenuToggleClass),
            ...
            e(a).each((function() {
                e(this).on("click", (function(t) {
                    var s;
                    t.preventDefault(),
                    e(s = this).next("ul").length > 0 ? (e(s).parent().toggleClass(i.subMenuParentToggle),
                    e(s).next("ul").slideToggle(i.toggleSpeed),
                    e(s).next("ul").toggleClass(i.subMenuToggleClass)) : e(s).prev("ul").length > 0 && (e(s).parent().toggleClass(i.subMenuParentToggle),
    ...
    e(window).on("scroll", (function() {
        ...
        e(window).scrollTop() > 800 ? (t.parent().addClass(s),
        o > a ? t.removeClass(i) : t.addClass(i)) : (t.parent().css("min-height", "").removeClass(s),
        t.removeClass(i)),
        a = o,
    ...
    e.fn.countdown = function() {
        e(this).each((function() {
            ...
            var a = setInterval((function() {
                ...
                n < 0 ? (clearInterval(a),
                t.addClass("expired"),
                t.find(".message").css("display", "block")) : (s(".day").html(o + " "),
                s(".hour").html(l + " "),
                s(".minute").html(r + " "),
                s(".seconds").html(c + " "))
            }
    ...
    e.fn.sectionPosition = function(t, i) {
        e(this).each((function() {
            ...
            "top-half" === a ? (e(n).css("padding-bottom", r + s + "px"),
            c.css("margin-top", "-" + s + "px")) : "bottom-half" === a && (e(n).css("padding-top", l + s + "px"),
    ...
    e(".service-circle__menu li a").each((function(t) {
        ...
        i.on("click", (function(t) {
            ...
            e(`.service-circle__item[data-tab-no="${i}"]`).addClass("active").siblings().removeClass("active")
        }
        ))
    }
    ))),
